...
认为超导球是线性均匀介质，则在球内磁标势都满足拉普拉斯方程：

$$
\nabla^2 \varphi_i = 0,\quad r<r_0
$$

$$
\nabla^2 \varphi_o = 0,\quad r>r_0
$$
...
取未放入超导球时球心处磁标势为零，在无穷远处，$\vec{H}\to \vec{H}_0,\varphi_o\to -H_0 r\cos\theta $，因此：
...
考虑分界面上 $\partial \Omega $ 磁标势要满足的边界条件：

$$
\varphi_i\big|_{\partial \Omega} = \varphi_o\big|_{\partial \Omega}
$$
