...
=\frac{\mathrm{d}\vec{v} }{\mathrm{d}t } -\left(\vec{v}\cdot\nabla \right)\vec{v}
$$
...
=n_s q_e \frac{\mathrm{d} \vec{v}_s }{\mathrm{d} t } 
=\frac{n_s q_e }{m } m\frac{\mathrm{d}\vec{v}_s }{\mathrm{d}t } 
=\frac{n_s q_e^2 \vec{E}}{m }
=\frac{n_s e^2 \vec{E} }{m } 
=\alpha \vec{E},\quad \alpha\equiv \frac{n_s e^2 }{m } 
$$

利用 $\nabla\times\vec{E} = -\partial \vec{B}/\partial t $ 可得：
