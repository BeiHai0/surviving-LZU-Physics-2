...
$$
\vec{A}(\vec{r},t)
=\sum_{\vec{k},s} \vec{\mathrm{e}}_{\vec{k}s}\left[A_{\vec{k}s}\exp\left(\mathrm{i}\left(\vec{k}\cdot\vec{r}-\omega_{\vec{k}}t \right) \right) + A_{\vec{k}s}^* \exp\left(-\mathrm{i}\left(\vec{k}\cdot\vec{r}-\omega_{\vec{k}}t \right) \right) \right]
$$
...
$$
\vec{E}(\vec{r},t)
=\mathrm{i}\sum_{\vec{k},s} \omega_k\vec{\mathrm{e}}_{\vec{k}s}\left[ \right]
$$
