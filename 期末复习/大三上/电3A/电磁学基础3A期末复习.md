...
\begin{aligned}
P(t')
&=\frac{q^2 }{16\pi^2\varepsilon_0 c^3 }\oint\frac{\left|\hat{r}\times\left[\left(\hat{r}-\vec{v}/c \right)\times\dot{\vec{v}} \right] \right|^2 }{\left(1-\dot{\vec{v}}\cdot\hat{r}/c \right)^5 }\mathrm{d}\Omega \\
